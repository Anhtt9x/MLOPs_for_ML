...
training_pipeline_config: TrainingPipelineConfig = TrainingPipelineConfig()  # type: ignore

@dataclass
class DataIngestionConfig:
    data_ingestion_dir:str = os.path.join(training_pipeline_config.artifact_dir, DATA_INGESTION_DIR_NAME)
    feature_store_file_path:str = os.path.join(data_ingestion_dir,DATA_INGESTION_FEATURE_STORE_DIR,FILE_NAME)
    tranining_file_path:str = os.path.join(data_ingestion_dir,DATA_INGESTION_INGESTED_DIR,TRAIN_FILE_NAME)
...
class DataValidationConfig:
    ...
    drift_report_file_path:str = os.path.join(data_validation_dir,DATA_VALIDATION_DRIFT_REPORT_DIR,
                                              DATA_VALIDATION_DRIFR_REPORT_FILE_NAME)
...
class ModelTrainerConfig:
    ...
    model_config_file_path: str = MODEL_TRAINER_MODEL_CONFIG_FILE_NAME