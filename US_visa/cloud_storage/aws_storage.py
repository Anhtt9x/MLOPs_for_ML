...
class SimpleStorageService:
    ...
    def read_object(object_name: str, decode: bool=True, make_readable:bool=False)-> Union[StringIO,str]:
        ...
        logging.info('Entered the read object method of S3Operations class')
        try:
            func = (
            ...
            logging.info('Exited the read object method of S3Operations class')
            return conv_func()
    ...
    def get_bucket(self, bucket_name:str)-> Bucket:
        try:
            ...
            logging.info('Exited the get bucket method of S3Operations class')
            return bucket
        except Exception as e:
            raise USvisaException(e,sys)
    ...
    def get_file_object(self, file_name:str, bucket_name:str)-> Union[List[object],object]:
        ...
        try:
            ...
            logging.info('Exited the get_file)object method of S3Operations class')
            return file_objs
        except Exception as e:
            raise USvisaException(e,sys)
    ...
    def load_model(self, model_name:str, bucket_name:str, model_dir:str=None) -> object:
        ...
        try:
            ...
            logging.info('Exited the load model method of S3Operations class')
            return model
        except Exception as e:
            raise USvisaException(e,sys)
    ...
    def upload_file(self, from_filename:str , to_filename:str, bucket_name:str, remove:bool=True):
        ...
        try:
            ...
            if remove is True:
                ...
                logging.info(f"Remove is set to {remove}, removing the file {from_filename}")
            else:
                logging.info(f"Remove is set to {remove}, not remove the file {from_filename}")
    ...
    def upload_df_as_csv(self, data_frame:DataFrame, local_filename:str, bucket_name:str, bucket_filename:str):
